      ...
      ${COLORED_OUTPUT_ENABLER}
        cmake -E time
          ...
          --profile clang
              ...
              -e <%= projectName %>:enable_llvm_tools=True
  ...
  execute_process(
    COMMAND
      ...
      cmake -E time cmake --build .
        --target <%= projectName %>_run_uncrustify
    WORKING_DIRECTORY ${CURRENT_SCRIPT_DIR}/.tmp/uncrustify_local_build
    TIMEOUT 7200 # sec
    RESULT_VARIABLE retcode
    ERROR_VARIABLE stderr
...
if(CLANG_FORMAT)
  ...
  execute_process(
    COMMAND
      ${COLORED_OUTPUT_ENABLER}
      cmake -E time cmake --build .
        --target <%= projectName %>_run_clang_format
    WORKING_DIRECTORY ${CURRENT_SCRIPT_DIR}/.tmp/clang_format_local_build
    TIMEOUT 7200 # sec
    RESULT_VARIABLE retcode
    ERROR_VARIABLE stderr
...
if(OCLINT)
  ...
  execute_process(
    COMMAND
      ${COLORED_OUTPUT_ENABLER}
      cmake -E time cmake --build .
        --target <%= projectName %>_run_oclint
    WORKING_DIRECTORY ${CURRENT_SCRIPT_DIR}/.tmp/oclint_local_build
    TIMEOUT 7200 # sec
    RESULT_VARIABLE retcode
    ERROR_VARIABLE stderr
...
if(CPPCLEAN)
  ...
  execute_process(
    COMMAND
      ${COLORED_OUTPUT_ENABLER}
      cmake -E time cmake --build .
        --target <%= projectName %>_run_cppclean
    WORKING_DIRECTORY ${CURRENT_SCRIPT_DIR}/.tmp/cppclean_local_build
    TIMEOUT 7200 # sec
    RESULT_VARIABLE retcode
    ERROR_VARIABLE stderr
...
if(CLANG_TIDY)
  ...
  execute_process(
    COMMAND
      ${COLORED_OUTPUT_ENABLER}
      cmake -E time cmake --build .
        --target <%= projectName %>_run_clang_tidy
    WORKING_DIRECTORY ${CURRENT_SCRIPT_DIR}/.tmp/clang_tidy_local_build
    TIMEOUT 7200 # sec
    RESULT_VARIABLE retcode
    ERROR_VARIABLE stderr
...
if(CPPCHECK)
  ...
  execute_process(
    COMMAND
      ${COLORED_OUTPUT_ENABLER}
      cmake -E time cmake --build .
        --target <%= projectName %>_run_cppcheck
    WORKING_DIRECTORY ${CURRENT_SCRIPT_DIR}/.tmp/cppcheck_local_build
    TIMEOUT 7200 # sec
    RESULT_VARIABLE retcode
    ERROR_VARIABLE stderr
